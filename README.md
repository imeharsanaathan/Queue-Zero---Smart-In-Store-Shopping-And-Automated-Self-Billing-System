...
### Payment demo
The UPI screen is intentionally a realistic visual scanner replica for the college project demonstration. It does not use a camera, real UPI credentials, or a live payment gateway; the existing demo payment action completes the mock transaction and creates the order.
